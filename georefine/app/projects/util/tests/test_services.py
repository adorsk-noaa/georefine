...
class Services_Test(BaseTest):
   ...
   "QUERIES":[
    ...
    def testProjects30Histogram(self):
        ...
        requests_json = '''
        [{"ID":"keyed_results","REQUEST":"execute_keyed_queries","PARAMETERS":{"KEY":{"KEY_ENTITY":{"ID":"x","EXPRESSION":"{{result.x}}","ALL_VALUES":true,"AS_HISTOGRAM":true,"CONTEXT":{"WHERE":[["{{result.t}}","==",2008],["{{result.t}}","==",2008]]}}},"QUERIES":[{"ID":"base","SELECT":[{"ID":"count_cell_id","EXPRESSION":"func.count({{inner.cell_id}})"}],"FROM":[{"ID":"inner","TABLE":{"ID":"inner","SELECT_GROUP_BY":true,"SELECT":[{"ID":"cell_id","EXPRESSION":"{{result.cell.id}}"}],"FROM":[],"WHERE":[["{{result.t}}","==",2008]],"GROUP_BY":[{"ID":"cell_id"},{"ID":"x","EXPRESSION":"{{result.x}}","ALL_VALUES":true,"AS_HISTOGRAM":true,"CONTEXT":{"WHERE":[["{{result.t}}","==",2008],["{{result.t}}","==",2008]]}}],"ORDER_BY":[]}}],"WHERE":[],"GROUP_BY":[{"ID":"x","EXPRESSION":"{{inner.x}}"}],"ORDER_BY":[],"SELECT_GROUP_BY":true},{"ID":"primary","SELECT":[{"ID":"count_cell_id","EXPRESSION":"func.count({{inner.cell_id}})"}],"FROM":[{"ID":"inner","TABLE":{"ID":"inner","SELECT_GROUP_BY":true,"SELECT":[{"ID":"cell_id","EXPRESSION":"{{result.cell.id}}"}],"FROM":[],"WHERE":[["{{result.t}}","==",2008],{}],"GROUP_BY":[{"ID":"cell_id"},{"ID":"x","EXPRESSION":"{{result.x}}","ALL_VALUES":true,"AS_HISTOGRAM":true,"CONTEXT":{"WHERE":[["{{result.t}}","==",2008],["{{result.t}}","==",2008]]}}],"ORDER_BY":[]}}],"WHERE":[],"GROUP_BY":[{"ID":"x","EXPRESSION":"{{inner.x}}"}],"ORDER_BY":[],"SELECT_GROUP_BY":true}]}}]
        '''
        import simplejson as json
