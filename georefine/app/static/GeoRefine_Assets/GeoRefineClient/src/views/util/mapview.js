...
function($, Backbone, _, _s, Util, MapView, requestsUtil, filtersUtil, formatUtil,colormapUtil){
  ...
  layerInitializers['georefine_data_layer'] = function(layer){
    ...
    // @TODO: assemble colorbar url here, based on parms from data entity.
    //data_entity.set('colorbar_url', 'http://l.yimg.com/g/images/en-us/flickr-yahoo-logo.png.v4');
    var colorbar_endpoint = '/georefine/projects/colorbar/';
